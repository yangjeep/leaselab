...
describe('getLeadsGroupedByUnit', () => {
    ...
    it('should group applications by unit', async () => {
        ...
        vi.mocked(getLeads).mockResolvedValue(mockMappedLeads);
        // Mock units query
        ...
        const result = await getLeadsGroupedByUnit(mockD1, 'site_1', {
            propertyId: 'prop_1',
        });
    ...
    it('should respect sortBy and sortOrder options', async () => {
        ...
        expect(result[0].applications[0].aiScore).toBeGreaterThanOrEqual(result[0].applications[1].aiScore ?? 0);
    });
});
