...
import { getApplicantsByApplicationId, createApplicant, updateApplicant, deleteApplicant, getApplicantByInviteToken, } from './application-applicants';
describe('application-applicants database helpers', () => {
    ...
    describe('getApplicantsByApplicationId', () => {
        it('should fetch all applicants for an application', async () => {
            ...
            const result = await getApplicantsByApplicationId(mockD1, 'lead_123');
        ...
        it('should return empty array when no applicants found', async () => {
            ...
            const result = await getApplicantsByApplicationId(mockD1, 'lead_999');
    ...
    describe('createApplicant', () => {
        it('should create a new applicant', async () => {
            ...
            const result = await createApplicant(mockD1, newApplicant);
    ...
    describe('updateApplicant', () => {
        it('should update applicant fields', async () => {
            ...
            const result = await updateApplicant(mockD1, 'app_123', updates);
    ...
    describe('deleteApplicant', () => {
        it('should delete an applicant', async () => {
            await deleteApplicant(mockD1, 'app_123');
    ...
    describe('getApplicantByInviteToken', () => {
        it('should find applicant by invite token', async () => {
            ...
            const result = await getApplicantByInviteToken(mockD1, 'token_xyz789');
        ...
        it('should return null when token not found', async () => {
            ...
            const result = await getApplicantByInviteToken(mockD1, 'invalid_token');
